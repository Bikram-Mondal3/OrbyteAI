            ...
            <Card className="hover:translate-y-[-2px] transition-transform">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="text-right">
                  <a href="#" className="text-sm font-bold text-[#FF7A00] hover:underline">
                    Forgot password?
                  </a>
                </div>
                ...
                <div className="relative">
                  ...
                  <div className="relative flex justify-center text-sm">
                    <span className="px-4 bg-[#FFF4E2] font-bold">or continue with</span>
                  </div>
                </div>
                ...
                <div className="text-center pt-4">
                  <p className="text-sm">
                    ...
                    <a href="/sign-up" className="font-bold text-[#FF7A00] hover:underline">
                      Sign up
                    </a>
                  </p>
                </div>
